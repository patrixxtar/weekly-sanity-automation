...
try:
    ...
    nav.stable_click((By.XPATH, "//a[contains(@href, '/en/phones/phones-summary.html?filter=A3112174#!/A3112174/tablets')]"))

    print("Successfully navigated to Tablet page.")
    time.sleep(2)
